...
type Snapshot = { storeName: string; productCount: number; sessions: number; converted: number; blocked: number; revenue: number; aov: number; recent: Session[] };
...
export default function MerchantPage() {
  ...
  return (
    <main className="merchant-shell">
      <aside className="merchant-sidebar"><a className="merchant-logo" href="/"><span><ShoppingBag /></span>intentcart</a><p>Merchant console</p><nav><a className="selected" href="/merchant"><Gauge />Overview</a><a href="#sessions"><Bot />Agent sessions</a><a href="/merchant/experiments"><Gauge />Experiments</a><a href="/merchant/orders"><PackageSearch />Orders</a><a href="/merchant/catalogue"><PackageSearch />Catalogue</a><a><ShieldCheck />Policies</a><a><TriangleAlert />Exceptions <b>{data?.blocked ?? 0}</b></a></nav><div className="merchant-side-card"><Sparkles /><strong>Catalogue readiness</strong><Progress value={100} /><span>{data?.productCount ?? 0} catalogue products</span></div><a className="back-shop" href="/demo"><ArrowLeft />Open buyer demo</a></aside>
      <section className="merchant-main">
        <header className="merchant-header"><div><p>{data?.storeName ?? "Your store"} · persisted activity</p><h1>Commerce operations overview</h1></div><AccountMenu /></header>
